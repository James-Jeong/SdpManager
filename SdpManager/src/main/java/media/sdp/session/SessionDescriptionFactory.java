package media.sdp.session;

import media.sdp.SdpFactory;
import media.sdp.field.ConnectionField;
import media.sdp.field.OriginField;
import media.sdp.field.SessionField;
import media.sdp.field.VersionField;
...
public class SessionDescriptionFactory extends SdpFactory {
    ...
    public String getData() {
        String result =
                // Version
                versionField.getVersionType() + "=" +
                        versionField.getVersion() +
                        CRLF +

                        // Origin
                        originField.getOriginType() + "=" +
        ...
        if (connectionField != null) {
            result +=
                    connectionField.getConnectionType() + "=" +
